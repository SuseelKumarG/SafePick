        ...
        if ($stmt->execute()) {
            ...
            try {
                ...
                $mail->Body = "
                    ...
                    <a href='http://172.27.74.43/dbmsproject/accepter.php?token=$token' style='
                    ...
                    <a href='http://172.27.74.43/dbmsproject/decliner.php?token=$token' style='
                        display: inline-block;
                        padding: 10px 20px;
                        font-size: 16px;
                        color: #ffffff;
                ...
                $mail->AltBody = "Hi, this email was sent by $username.\nParcel ID: $pid\nParcel Description: $pd\nAccept: http://172.27.74.43/dbmsproject/accepter.php?token=$token\nDecline: http://172.27.74.43/dbmsproject/decliner.php?token=$token";
